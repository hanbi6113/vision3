// app/components/common/site-header.tsx
"use client";
...
const navItems = [
  ...
  { label: "Discover", href: "/discover", isFree: true },
...
function getHeaderTheme(pathname: string): HeaderTheme {
  ...
  if (pathname === "/movies") return hallThemes["movies-rofan"];
  if (pathname === "/discover") return hallThemes["series-rofan"];
