// components/ott/ott-2-shell.tsx
...
> = {
  rofan: {
    hallName: "Royal Fantasy Hall",
    hallDesc:
      "황궁의 긴장감과 감정선을 더 화려하게 보여주는 프리미엄 상영관.",
    continueLabel: "궁정에서 이어보기",
    trendingLabel: "지금 가장 주목받는 궁정 서사",
    shelfA: "오늘의 황궁 추천",
    shelfB: "관계선이 강한 작품",
    editorLabel: "황궁 하이라이트",
    upcomingLabel: "곧 공개될 궁정 신작",
  },
  romance: {
    hallName: "Romance Hall",
    hallDesc:
      "조용한 감정선과 여운이 오래 남는 작품을 모은 프리미엄 로맨스 관.",
    continueLabel: "감정선 이어보기",
    trendingLabel: "오늘의 로맨스 인기작",
    shelfA: "여운이 남는 작품",
    shelfB: "지금 많이 보는 관계 서사",
    editorLabel: "로맨스 하이라이트",
    upcomingLabel: "곧 공개될 로맨스 신작",
  },
  sf: {
    hallName: "Science Fiction Hall",
    hallDesc:
      "미래 도시와 시스템 서사를 더 강하게 몰입해서 보는 프리미엄 SF 관.",
    continueLabel: "시스템 로그 이어보기",
    trendingLabel: "지금 가장 반응이 큰 SF",
    shelfA: "System Picks",
    shelfB: "Archive Selection",
    editorLabel: "Signal Highlight",
    upcomingLabel: "곧 공개될 미래 서사",
  },
  murim: {
    hallName: "Murim Hall",
    hallDesc:
      "문파와 검객의 흐름을 더 묵직하게 보여주는 프리미엄 무협 상영관.",
    continueLabel: "강호에서 이어보기",
    trendingLabel: "지금 가장 강한 무협 작품",
    shelfA: "문파 추천작",
    shelfB: "검객 서사 모음",
    editorLabel: "강호 하이라이트",
    upcomingLabel: "곧 공개될 무협 신작",
  },
  horror: {
    hallName: "Horror Hall",
    hallDesc:
      "불길한 정적과 심리적 긴장을 더 진하게 체감하게 하는 프리미엄 공포 관.",
    continueLabel: "이상 징후 이어보기",
    trendingLabel: "Tonight’s Picks",
    shelfA: "가장 반응이 큰 공포작",
    shelfB: "불길한 큐레이션",
    editorLabel: "심야 하이라이트",
    upcomingLabel: "곧 공개될 공포 신작",
  },
};
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-5 py-8 md:px-8 lg:px-10">
        ...
        >
          <div>
            ...
            <p className={`mt-4 max-w-3xl text-sm leading-7 sm:text-base ${bodyColorClass}`}>
              같은 OTT 안에서도 장르마다 다른 상영관에 들어온 것처럼 보이게 설계한
              프리미엄 홈 시안이야.
            </p>
          </div>
        ...
        {/* hall hero */}
        <section className={`overflow-hidden rounded-[36px] border ${shellClass}`}>
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            {upcoming.map((item) => (
              ...
              >
                ...
                <div className="p-5">
                  <span className={`rounded-full border px-3 py-1.5 text-[11px] font-bold uppercase tracking-[0.18em] ${softChipClass}`}>
                    {item.day}
                  </span>
